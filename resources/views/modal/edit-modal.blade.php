<div id="simpleEditModal" class=" fixed hidden pl-20 pr-36 z-30 left-0 top-0 w-full h-full overflow-auto bg-black bg-opacity-50">
    <div class=" flex flex-col py-5 ml-96 mt-10 mb-10 w-9/12 space-y-10 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ">
        <span class="closeBtn text-gray-400 pr-10 text-right text-4xl hover:text-black hover:no-underline focus:text-black focus:no-underline cursor-pointer font-bold ">&times;</span>
        <h1 class="text-xl text-center font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-white">
            Edit account
        </h1>
        <form class=" flex flex-col px-10 space-y-10" method="POST" action="/dashboard/{{ $user->id }}" enctype="multipart/form-data" >
            @csrf
            @method('PUT')
            <div class=" flex flex-row justify-evenly">
                <div class=" flex flex-col w-5/12 space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="first_name" id="first_name" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="First Name" value="{{ $user->first_name }}" >
                ...
                <div class=" flex flex-col w-5/12 space-y-5">
                    ...
                    <div>
                        ...
                        <option value="{{ $user->department }}" selected>Choose a department</option>
